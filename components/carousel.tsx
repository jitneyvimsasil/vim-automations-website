...
export function Carousel() {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 md:-translate-x-20 p-3 text-[#e0ff4f] hover:bg-[#e0ff4f]/10 rounded-lg transition-all duration-200 hover:scale-110 hover:shadow-md"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 md:translate-x-20 p-3 text-[#e0ff4f] hover:bg-[#e0ff4f]/10 rounded-lg transition-all duration-200 hover:scale-110 hover:shadow-md"
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`transition-all duration-300 rounded-full ${
              index === currentSlide
                ? 'w-3 bg-gradient-to-r from-[#e0ff4f] to-[#a0c830] shadow-md'
                : 'w-2 bg-[#e0ff4f]/30 hover:bg-[#e0ff4f]/50 hover:scale-110'
            }`}
            style={{ height: '8px' }}
