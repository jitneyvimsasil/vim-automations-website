...
const logos = [
  ...
  },
  {
    name: 'Tavily',
    icon: (
      <span className="w-5 h-5 flex items-center justify-center rounded bg-current/10 text-[10px] font-bold">
        T
      </span>
    ),
  },
  {
    name: 'IFTTT',
    icon: (
      <span className="text-xs font-black tracking-tight">IFTTT</span>
    ),
  },
  {
  ...
  },
  {
    name: 'imgbb',
    icon: (
      <span className="text-xs font-bold tracking-tight">img</span>
    ),
  },
  {
    name: 'Railway',
  ...
  return (
    <section className="py-16 px-6 overflow-hidden" aria-label="Technologies used">
      <div className="max-w-5xl mx-auto mb-10">
        <h3 className="text-xs font-bold uppercase tracking-[0.2em] bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent text-center">
          Tools & Technologies
        </h3>
      </div>
        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-14 px-7">
            {logos.map((logo, i) => (
              <div
                key={`a-${i}`}
                className="flex items-center gap-2.5 text-muted-foreground hover:text-foreground transition-colors duration-200 shrink-0"
              >
                <span className="w-6 h-6 flex items-center justify-center">{logo.icon}</span>
